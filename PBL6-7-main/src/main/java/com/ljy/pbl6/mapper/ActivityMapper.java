...
public interface ActivityMapper {
    ...
    @Insert("INSERT INTO sys_activity (id, activity_name, activity_desc, cover_url, start_time, end_time, status, hot_status, creator, create_time, update_time) VALUES (#{id}, #{activityName}, #{activityDesc}, #{coverUrl}, #{startTime}, #{endTime}, #{status}, #{hotStatus}, #{creator}, #{createTime}, #{updateTime})")
